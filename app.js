const menuData = [
        ...
        { label: 'veg', category: 'Fries', item: 'Classic Salted Fries', price: 99 },
        { label: 'veg', category: 'Fries', item: 'Peri Peri Fries', price: 119 },
        { label: 'veg', category: 'Fries', item: 'Cheese Loaded Fries', price: 139 },
        { label: 'veg', category: 'Burgers', item: 'Veg Patty Burger', price: 100 },
        { label: 'veg', category: 'Burgers', item: 'Paneer Pillow Burger', price: 130 },
        { label: 'veg', category: 'Burgers', item: 'Mushroom Burger', price: 140 },
        { label: 'non-veg', category: 'Burgers', item: 'Egg Patty Burger', price: 80 },
        { label: 'non-veg', category: 'Burgers', item: 'Egg & Cheese Burger', price: 100 },
        { label: 'non-veg', category: 'Burgers', item: 'Classic Chicken Patty Burger', price: 129 },
        { label: 'non-veg', category: 'Burgers', item: 'Peri Peri Chicken Burger', price: 149 },
        { label: 'non-veg', category: 'Burgers', item: 'Chipotle Chicken Burger', price: 149 },
        ...
        { label: 'non-veg', category: 'Square Pan Pizza', item: 'Peri Peri Chicken Pizza', price: 229 },
        { label: 'non-veg', category: 'Square Pan Pizza', item: 'Chipotle Chicken Pizza', price: 249 },
        { label: 'non-veg', category: 'Square Pan Pizza', item: 'Hawaiian Chicken Pizza', price: 150 },
        ...
        { label: 'veg', category: 'Desserts', item: 'Chocolate Momo', price: 299 },
        { label: 'non-veg', category: 'K Specials', item: 'Inverted Burger', price: 249 },
